...
// ~ 보다 큼 또는 작음 → boolean
let lessThan = number[0] < number[3];
console.log(lessThan);
let greaterThan = number[0] > number[1];
console.log(greaterThan);

// ~ 보다 크거나 작음 또는 같음 → boolean
let lessThanAndEqual = number[4] <= number[1];
console.log(lessThanAndEqual);
let greaterThanAndEqual = number[5] >= number[0];
